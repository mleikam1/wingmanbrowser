...
class WebKitWebViewControllerCreationParams extends PlatformWebViewControllerCreationParams {
  ...
  /// Wingman extension: native configuration identity for pre-creation storage
  /// isolation. The app MUST await native configuration before creating a view.
  int get wingmanConfigurationIdentifier =>
      PigeonInstanceManager.instance.getIdentifier(_configuration)!;
