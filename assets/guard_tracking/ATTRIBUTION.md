...
This browser-rule adapter filters third-party browser subresources, not main-frame navigation. It cannot inspect or alter a third-party advertising SDK's own views; that technical boundary is not a commercial privacy exemption. Wingman's separate monetization policy denies GMA requests before consent/SDK contact when protection requirements are strict or unknown. Any provider considered for standard requirements still needs privacy review and disclosure; revenue never authorizes otherwise prohibited tracking. Preserve first-party access and the user's temporary site-level Tracking Protection exception. Exceptions must not weaken TLS, phishing, malware or voluntary Guard category policy.
